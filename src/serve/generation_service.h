...
struct GenerationMetrics {
    ...
    std::vector<std::uint64_t> speculative_fallbacks_per_window;
    std::vector<std::uint64_t> speculative_drafted_tokens_per_window;
    std::vector<std::uint64_t> speculative_accepted_tokens_per_window;
    std::vector<std::uint64_t> speculative_committed_tokens_per_window;
    std::vector<double> speculative_decode_seconds_per_window;
