...
void launch_kernel(const Tensor& x, const Weight& w, Tensor& residual_out, hipStream_t stream) {
...
void launch_route(const Tensor& x, const Weight& w, Tensor& residual_out, hipStream_t stream) {
