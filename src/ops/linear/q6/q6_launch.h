...
using Q6Launch = void (*)(const Tensor&, const Weight&, Tensor&, hipStream_t);
...
void launch_q6_mma_r64_c16_k128(const Tensor& x, const Weight& w, Tensor& out, hipStream_t stream);
void launch_q6_mma_r64_c24_k128(const Tensor& x, const Weight& w, Tensor& out, hipStream_t stream);
void launch_q6_mma_r64_c32_k128(const Tensor& x, const Weight& w, Tensor& out, hipStream_t stream);
void launch_q6_mma_r64_c40_k128(const Tensor& x, const Weight& w, Tensor& out, hipStream_t stream);
void launch_q6_mma_r64_c48_k128(const Tensor& x, const Weight& w, Tensor& out, hipStream_t stream);
void launch_q6_mma_r64_c56_k128(const Tensor& x, const Weight& w, Tensor& out, hipStream_t stream);
void launch_q6_mma_r64_c64(const Tensor& x, const Weight& w, Tensor& out, hipStream_t stream);
void launch_q6_mma_r64_c64_k128(const Tensor& x, const Weight& w, Tensor& out, hipStream_t stream);
void launch_q6_mma_r64_c72_k128(const Tensor& x, const Weight& w, Tensor& out, hipStream_t stream);
void launch_q6_mma_r64_c80(const Tensor& x, const Weight& w, Tensor& out, hipStream_t stream);
void launch_q6_mma_r64_c88_k128(const Tensor& x, const Weight& w, Tensor& out, hipStream_t stream);
