...
hipError_t launch_fixed(const prepare_wy_wu_config& cfg, dim3 grid, head_map qk_map) {
    ...
    hipError_t err =
        hipFuncSetAttribute(reinterpret_cast<const void*>(kernel::prepare_wy_wu_kernel<KPanelCols, WuPanelCols, BlockWarps>),
