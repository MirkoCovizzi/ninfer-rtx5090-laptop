...
void launch_folded(const Tensor& x, const Weight& weight, Tensor& out, hipStream_t stream) {
...
template <class Cfg>
void launch_route(const Tensor& x, const Weight& weight, Tensor& out, hipStream_t stream) {
