...
- `test_ninfer_bench_support.cpp` — product benchmark CLI, timing boundary, and schema-v11 reports;
- `test_bench_matrix.py` — schema-v11 report consumption by the Python matrix summarizer;
