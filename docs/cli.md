...
| `--kv-dtype bf16\|int8\|fp8\|kvarn` | KV-cache storage (`kvarn` is Huawei K4V2-G64) | `bf16` |
...
storage. KVarN K4V2-G64, INT8 group-64, and BF16 are also available. Artifact identity selects the weight profile;
